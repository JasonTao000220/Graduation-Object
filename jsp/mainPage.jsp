                        ...
                        <div class="panel">
                          <div class="panel-header">
                            ...
                            <span class="panel-title">
                              <span class="textcolor_orange">Rating ranking</span>
                            </span>
                          </div>
        ...
        function initHostMovie(){
            ...
            $.ajax({
                ...
                success:function (obj) {
                    HotNum.append("<span class=\"textcolor_red\">Is showing（" + obj.data.length + "unit）</span>");
                    ...
                    for(var i=0;i<sortMovieList;i++){
                    	...
                    	if(i == 0){
                                ...
                                "<div class=\"ranking-top-right\">"+
                                  "<div class=\"ranking-top-right-main\">"+
                                    "<span class=\"ranking-top-moive-name\">"+obj.sort[i].movie_cn_name+"</span>"+
                                      ...
                                      "<p class=\"ranking-release-time\">release time："+datefomate(releaseDate)+"</p>"+
                        
                                      "<p class=\"ranking-top-wish\">"+
                                          "<span class=\"stonefont\">"+obj.sort[i].movie_score+"</span>score"+
                                      "</p>"+
                                  "</div>"+
                                "</div>"+
                              "</a>"+
                    		...
                    		htmlSort = "<li class=\"ranking-item ranking-index-2\" onclick=\"window.location.href='/jsp/buyTickets.jsp?movie_id="+obj.sort[i].movie_id+"'\">"+
	                            ...
	                            "<span class=\"ranking-num-info\"><span class=\"stonefont\">"+obj.sort[i].movie_score+"</span>score</span>"+
	                        "</a>"+
	                      "</li>";
	                        sortMovie.append(htmlSort);
                    	}else if(i == 2){
	                      ...
	                      "</li>";
                            ...
                            "<span class=\"ranking-num-info\"><span class=\"stonefont\">"+obj.sort[i].movie_score+"</span>score</span></span>"+
	                        "</a>"+
	                      "</li>";
                        	sortMovie.append(htmlSort);
                    	}
